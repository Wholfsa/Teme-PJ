...
public class MainAPP {
    ...
    public static int numarColiPal(List<Mobilier> listaMobilier, String numeMobilier) {
        ...
        for (Mobilier mobilier : listaMobilier) {
            if (mobilier.getNume().equalsIgnoreCase(numeMobilier)) {
                ...
                //math.ceil funtia asta rotunjeste in sus un nr real la cel mai apropiat intreg >= cu el
                //ex math.ceil(4.1)->5.0 sau math.ceil(-3.8)->-3
    ...
    public static void main(String[] args) {
        // citirea din JSON
        List<Mobilier> listaMobilier = citireMobilier("C:\\Users\\wholf\\IdeaProjects\\WorkSpacePJ\\lab5ex3\\src\\main\\resources\\mobilier.json");
