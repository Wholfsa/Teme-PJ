...
public class MainAPP {
    private static final String FILE_PATH = "C:\\Users\\wholf\\IdeaProjects\\WorkSpacePJ\\lab7ex1\\src\\main\\resources\\carti.json";
    private static Map<Integer, Carte> carti = new HashMap<>();
    private static Scanner scanner = new Scanner(System.in);

    public static void main(String[] args) throws IOException {
        // initializam colectia citind fisierul Json
        citesteFisier();
        ...
        do {
            ...
            switch (opt) {
                case 1: afisColectia();
                break;
                case 2:stergereCarte();
                break;
                case 3:adaugCarte();
                break;
                case 4:salveazaFisier();
                break;
                case 5:filtreazaAutor("Yuval Noah Harari");
                break;
                case 6:sorteazaTitlu();
                break;
                case 7:afisVeche();
                break;
                case 0 :System.out.println("Zi buna.");
                return;
    ...
    private static void citesteFisier() throws IOException {
        ...
        //Map.Entry<String, Map<String, Object>> reprezinta fiecare pereche cheie-valoare din data de ex din fisierul Json poate fi Id o pereche
